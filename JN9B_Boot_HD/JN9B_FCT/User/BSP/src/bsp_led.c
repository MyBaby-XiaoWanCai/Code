...
{
	#ifdef YCJ
	RUN_LED_PORT_R, RUN_LED_PORT_G, CH1_LED_PORT_R, CH1_LED_RORT_G,
	CH2_LED_PORT_R, CH2_LED_PORT_G, CH3_LED_PORT_R, CH3_LED_PORT_G,
	CH4_LED_PORT_R, CH4_LED_PORT_G, CH5_LED_PORT_R, CH5_LED_RORT_G,
	CH6_LED_PORT_R, CH6_LED_RORT_G, CH7_LED_PORT_R, CH7_LED_RORT_G,
	CH8_LED_PORT_R, CH8_LED_RORT_G, GPIO_PORT_NOUSE, GPIO_PORT_LED82,
	GPIO_PORT_LED83
	#else
	RUN_LED_PORT_R, RUN_LED_PORT_G, CH1_LED_PORT_R, CH1_LED_RORT_G,
	CH2_LED_PORT_R, CH2_LED_PORT_G, CH3_LED_PORT_R, CH3_LED_PORT_G,
...
void bsp_InitLed(void)
{
    ...
    (void)GPIO_Init(CH1_LED_RORT_G,  CH1_LED_PIN_G,  &stcLedGpioInit);
    ...
    (void)GPIO_Init(CH5_LED_RORT_G,  CH5_LED_PIN_G,  &stcLedGpioInit);
