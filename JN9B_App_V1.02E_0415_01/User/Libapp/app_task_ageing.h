...
#ifdef YCJ
#define AGEING_TIME_CFG				(3.65 * 3600)      //25*360 (2.5 * 3600)		//5Hour
//#define AGEING_TIME_CFG				(110)      //15s
#define AGEING_RUN_TIME		(6 * 3600)	//老化运行时间 定时器计算
#else
...
//自检老化地址
#define AGEING_LIB_ADDR					8				//库号
//#define AGEING_LIB_ADDR			  4				//库号，当前控制板的IP第一位识别有问题，可能原因是MCU的PH6有问题
