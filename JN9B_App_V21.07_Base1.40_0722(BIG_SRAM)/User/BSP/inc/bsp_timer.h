...
#define APP_TMRA1_INT_PRIO                   (DDL_IRQ_PRIORITY_09)
...
#define APP_TMRA2_INT_PRIO                   (DDL_IRQ_PRIORITY_03)
...
#define APP_TMRA3_INT_PRIO                   (DDL_IRQ_PRIORITY_09)
...
#define APP_TMRA4_INT_PRIO                   (DDL_IRQ_PRIORITY_01)
#define APP_TMRA4_INT_SRC                    (INT_TMRA_4_OVF)
...
#define APP_TMRA4_PERIOD_VAL                 (30000UL - 1UL)           //1ms中断一次
/**********************************************************************************************************
**                                           类型定义区
**********************************************************************************************************/
