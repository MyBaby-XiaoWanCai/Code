...
extern int32_t InitAD7175(void);
extern int32_t AD7175_Reset(void);
extern int32_t AD7175_CfgADC(void);
extern uint8_t AD7175_ComputeCRC8(uint8_t * pBuf,uint8_t bufSize);
extern uint8_t AD7175_ComputeXOR8(uint8_t * pBuf,uint8_t bufSize);
extern int32_t AD7175_WaitForReady(uint32_t timeout);
extern int32_t AD7175_ReadData(uint8_t* pData);
