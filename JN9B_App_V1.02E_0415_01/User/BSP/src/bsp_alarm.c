...
{
	Pca9548A_Select(I2C_PCA9548,CHx,PCA_9555_ON);	//打开对应故障通道
	
	Pca9555_RegRead(I2C_PCA9548, PCA9555_DEVICE_ADDR,Pca9555_Data.Power_Board[CHx].ReadData);	//故障信息读取
...
void PowerFault_Init(void)
{
		PowerFaultExint_Init(GPIO_PORT_POWERFAULT_1,GPIO_PIN_POWERFAULT_1,POWERFAULT_1_EXINT_CH,
							POWERFAULT_1_INT_SRC,POWERFAULT_1_IRQn,PowerFault1_EXINT_IrqCallback,PROIORITY_GROUP_1);
