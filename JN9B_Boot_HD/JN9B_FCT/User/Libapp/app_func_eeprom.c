...
void CalibrateDatInit(uint8_t chx)
{
	...
	Tier2.calibrate[j].IhSetK_C     = 1446.795776; //修改1
	Tier2.calibrate[j].IhSetB_C     = 28.938089;   //修改1
	...
	Tier2.calibrate[j].IhK_C        = 61.420502;   //修改1
	Tier2.calibrate[j].IhB_C        = -0.868701;   //修改1
	...
	Tier2.calibrate[j].IhSetK_D     = 1446.990967;  //修改1
	Tier2.calibrate[j].IhSetB_D     = 24.315275;    //修改1
	...
	Tier2.calibrate[j].IhK_D        = 68.291725;    //修改1
	Tier2.calibrate[j].IhB_D        = -1.236232;    //修改1
