...
void bsp_AD7606_init(void)
{
    ...
    NVIC_SetPriority(AD7606_IRQn, DDL_IRQ_PRIORITY_02); //设置优先级
    ...
    NVIC_SetPriority(AD7606_Busy0_IRQn, DDL_IRQ_PRIORITY_02); //设置优先级
...
**  返 回 值 : 无
**********************************************************************************************************/
uint8_t AD7606_Vsense_Debug = 0x00;
int32_t AD7606_Vsense_L = 0x000052FB;
int32_t AD7606_Vsense_H = 0x000056FB;
...
/*****************************************************************************************/					
				if(AD7606_Vsense_Debug == 0x01)
				{
					for(uint8_t k = 0;k<2;k++)
					{
						if(AD7606_Vsense_H <= AD7606_A0.AVG_ADC[k] || AD7606_A0.AVG_ADC[k] <= AD7606_Vsense_L)
						{
							AD7606_Vsense_Debug = 0x02;
						}
					}
				}
/*****************************************************************************************/			
...
**  返 回 值 : 无
**********************************************************************************************************/
uint8_t AD7606_Iout_Debug = 0x00;
int32_t AD7606_Iout_L = 0x00000D46;
int32_t AD7606_Iout_H = 0x00000DA6;
uint8_t ch_x_iont = 0;
...
/*****************************************************************************************/						
				if(AD7606_Iout_Debug == 0x01)	//测试用
				{
					for(uint8_t j =0;j<2;j++)
					{
						if(AD7606_Iout_H <= AD7606_A1.AVG_ADC[j] || AD7606_A1.AVG_ADC[j] <= AD7606_Iout_L)
						{
							AD7606_Iout_Debug = 0x02;
						}
					}
				}
/*****************************************************************************************/				
