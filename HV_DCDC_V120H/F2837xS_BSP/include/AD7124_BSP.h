...
#ifndef F2837XS_BSP_INCLUDE_AD7124_BSP_H_
#define F2837XS_BSP_INCLUDE_AD7124_BSP_H_
...
/******************************************************************************/
extern INT8U AD7124_Start_Read;
extern uint32_t ad7124_value[16];
extern INT8U ad7124_compute_crc8(INT8U * p_buf, INT8U buf_size);
extern int32_t AD7124_WriteReg(INT8U addr,int32_t Value,INT8U size);
extern int32_t AD7124_ReadReg(INT8U addr,INT8U * Value,INT8U size);
extern int32_t InitAD7124(void);
extern int32_t AD7124_CfgADC(void);
extern int32_t ad7124_wait_to_power_on(uint32_t timeout);
extern int32_t AD7124_WaitFor_SPI_Ready(uint32_t timeout);
extern int32_t AD7124_WaitFor_Conv_Ready(INT8U* ch,uint32_t timeout);
extern int32_t AD7124_ReadData(INT8U* pData);
extern void AD7124_Process(void);
...
typedef struct struct_Data_AD7124_Sum
{
    Uint16 Cnt_Sum;         //当前累加次数计数器
    Uint16 Num_Avg;         //平均值累加次数

    int32 J1Vol_AD;
    int32 Sum_J1Vol_AD;   //累加过程累加值
    int32 Sum_J1Vol_AD_Copy;//累加Num_Avg次后的累加值

    int32 J2Vol_AD;
    int32 Sum_J2Vol_AD;   //累加过程累加值
    int32 Sum_J2Vol_AD_Copy;//累加Num_Avg次后的累加值

    int32 J3Vol_AD;
    int32 Sum_J3Vol_AD;   //累加过程累加值
    int32 Sum_J3Vol_AD_Copy;//累加Num_Avg次后的累加值

    int32 J4Vol_AD;
    int32 Sum_J4Vol_AD;   //累加过程累加值
    int32 Sum_J4Vol_AD_Copy;//累加Num_Avg次后的累加值
...
} struct_Data_AD7124_Sum;




extern struct_Data_AD7124_Sum Data_AD7124_Sum;



#endif    /* F2837XS_BSP_INCLUDE_AD7124_BSP_H_ */
