...
#define GLOBAL_initial_voltage_high                         1
#define GLOBAL_initial_voltage_low                          1
#define GLOBAL_contact_voltage_variation                    1
...
//全局保护使能宏定义==================================================================================
        ...
        //other_fault                           //其他故障报警
        //sum_capacitance                       //总容量上限保护
        //watch_dog                             //看门狗复位保护
        //loop_voltage_difference               //回路压差保护
        //output_voltage_high                   //输出端口过压保护
...
#define GLOBAL_STANDBY_battery_UnderTemperature_alarm       1
#define GLOBAL_STANDBY_battery_OverTemperature_warning      1
#define GLOBAL_STANDBY_battery_OverTemperature_alarm        1
#define GLOBAL_STANDBY_reverse_battery                      1
#define GLOBAL_STANDBY_contact_impedance                    0
#define GLOBAL_STANDBY_fluctuation_BatteryVoltage           0
...
#define GLOBAL_STANDBY_BUS_low_fault                        1
#define GLOBAL_STANDBY_BUS_high_fault                       1
...
#define GLOBAL_STANDBY_sum_capacitance                      0
#define GLOBAL_STANDBY_loop_voltage_difference              1
#define GLOBAL_STANDBY_output_voltage_high                  1
//--------------------------------------------------------------------------------------------------
...
#define GLOBAL_CC_battery_UnderTemperature_alarm       1
#define GLOBAL_CC_battery_OverTemperature_warning      1
#define GLOBAL_CC_battery_OverTemperature_alarm        1
#define GLOBAL_CC_reverse_battery                      1
#define GLOBAL_CC_contact_impedance                    1
#define GLOBAL_CC_fluctuation_BatteryVoltage           0
#define GLOBAL_CC_fluctuation_OutputCurrent            0
#define GLOBAL_CC_output_OverVoltage                   0
...
#define GLOBAL_CC_BUS_low_fault                        1
#define GLOBAL_CC_BUS_high_fault                       1
...
#define GLOBAL_CC_sum_capacitance                      1
#define GLOBAL_CC_loop_voltage_difference              1
#define GLOBAL_CC_output_voltage_high                  1
//--------------------------------------------------------------------------------------------------
...
#define GLOBAL_CV_battery_UnderTemperature_alarm       1
#define GLOBAL_CV_battery_OverTemperature_warning      1
#define GLOBAL_CV_battery_OverTemperature_alarm        1
#define GLOBAL_CV_reverse_battery                      1
#define GLOBAL_CV_contact_impedance                    1
#define GLOBAL_CV_fluctuation_BatteryVoltage           0
#define GLOBAL_CV_fluctuation_OutputCurrent            0
#define GLOBAL_CV_output_OverVoltage                   0
...
#define GLOBAL_CV_BUS_low_fault                        1
#define GLOBAL_CV_BUS_high_fault                       1
...
#define GLOBAL_CV_sum_capacitance                      1
#define GLOBAL_CV_loop_voltage_difference              1
#define GLOBAL_CV_output_voltage_high                  1
//--------------------------------------------------------------------------------------------------
...
#define GLOBAL_CC_to_CV_battery_UnderTemperature_alarm       1
#define GLOBAL_CC_to_CV_battery_OverTemperature_warning      1
#define GLOBAL_CC_to_CV_battery_OverTemperature_alarm        1
#define GLOBAL_CC_to_CV_reverse_battery                      1
#define GLOBAL_CC_to_CV_contact_impedance                    1
#define GLOBAL_CC_to_CV_fluctuation_BatteryVoltage           0
#define GLOBAL_CC_to_CV_fluctuation_OutputCurrent            0
#define GLOBAL_CC_to_CV_output_OverVoltage                   0
...
#define GLOBAL_CC_to_CV_BUS_low_fault                        1
#define GLOBAL_CC_to_CV_BUS_high_fault                       1
...
#define GLOBAL_CC_to_CV_sum_capacitance                      1
#define GLOBAL_CC_to_CV_loop_voltage_difference              1
#define GLOBAL_CC_to_CV_output_voltage_high                  1
//--------------------------------------------------------------------------------------------------
...
#define GLOBAL_CP_sum_capacitance                      0
//--------------------------------------------------------------------------------------------------
...
#define GLOBAL_DCC_battery_UnderTemperature_alarm       1
#define GLOBAL_DCC_battery_OverTemperature_warning      1
#define GLOBAL_DCC_battery_OverTemperature_alarm        1
#define GLOBAL_DCC_reverse_battery                      1
#define GLOBAL_DCC_contact_impedance                    1
#define GLOBAL_DCC_fluctuation_BatteryVoltage           0
#define GLOBAL_DCC_fluctuation_OutputCurrent            0
#define GLOBAL_DCC_output_OverVoltage                   0
...
#define GLOBAL_DCC_BUS_low_fault                        1
#define GLOBAL_DCC_BUS_high_fault                       1
...
#define GLOBAL_DCC_sum_capacitance                      1
#define GLOBAL_DCC_loop_voltage_difference              1
#define GLOBAL_DCC_output_voltage_high                  1
//--------------------------------------------------------------------------------------------------
...
#define GLOBAL_DCV_battery_UnderTemperature_alarm       1
#define GLOBAL_DCV_battery_OverTemperature_warning      1
#define GLOBAL_DCV_battery_OverTemperature_alarm        1
#define GLOBAL_DCV_reverse_battery                      1
#define GLOBAL_DCV_contact_impedance                    1
#define GLOBAL_DCV_fluctuation_BatteryVoltage           0
#define GLOBAL_DCV_fluctuation_OutputCurrent            0
#define GLOBAL_DCV_output_OverVoltage                   0
...
#define GLOBAL_DCV_BUS_low_fault                        1
#define GLOBAL_DCV_BUS_high_fault                       1
...
#define GLOBAL_DCV_sum_capacitance                      1
#define GLOBAL_DCV_loop_voltage_difference              1
#define GLOBAL_DCV_output_voltage_high                  1
//--------------------------------------------------------------------------------------------------
...
#define GLOBAL_DCC_to_DCV_battery_UnderTemperature_alarm       1
#define GLOBAL_DCC_to_DCV_battery_OverTemperature_warning      1
#define GLOBAL_DCC_to_DCV_battery_OverTemperature_alarm        1
#define GLOBAL_DCC_to_DCV_reverse_battery                      1
#define GLOBAL_DCC_to_DCV_contact_impedance                    1
#define GLOBAL_DCC_to_DCV_fluctuation_BatteryVoltage           0
#define GLOBAL_DCC_to_DCV_fluctuation_OutputCurrent            0
#define GLOBAL_DCC_to_DCV_output_OverVoltage                   0
...
#define GLOBAL_DCC_to_DCV_BUS_low_fault                        1
#define GLOBAL_DCC_to_DCV_BUS_high_fault                       1
...
#define GLOBAL_DCC_to_DCV_sum_capacitance                      1
#define GLOBAL_DCC_to_DCV_loop_voltage_difference              1
#define GLOBAL_DCC_to_DCV_output_voltage_high                  1
//--------------------------------------------------------------------------------------------------
...
#define GLOBAL_DCP_sum_capacitance                      0
//--------------------------------------------------------------------------------------------------
...
//单工步保护使能宏定义================================================================================
        ...
        //step_abort_priority                       //截止优先级
        //UnderTemperature_alarm                    //电池温度下限保护
        //timing_voltage_high                       //定时电压上限保护
        //timing_voltage_low                        //定时电压下限保护
        //timing_voltage_change                     //定时电压变化量异常
        //battery_short_voltage_high                //电池短路电压上限保护
        //battery_short_voltage_low                 //电池短路电压下限保护
...
#define STEP_STANDBY_step_abort_priority                0
#define STEP_STANDBY_UnderTemperature_alarm             1
#define STEP_STANDBY_timing_voltage_high                1
#define STEP_STANDBY_timing_voltage_low                 1
#define STEP_STANDBY_timing_voltage_change              0
#define STEP_STANDBY_battery_short_voltage_high         0
#define STEP_STANDBY_battery_short_voltage_low          0
//--------------------------------------------------------------------------------------------------
...
#define STEP_CC_charge_current_limit               0
...
#define STEP_CC_step_abort_priority                1
#define STEP_CC_UnderTemperature_alarm             1
#define STEP_CC_timing_voltage_high                1
#define STEP_CC_timing_voltage_low                 1
#define STEP_CC_timing_voltage_change              1
#define STEP_CC_battery_short_voltage_high         1
#define STEP_CC_battery_short_voltage_low          1
//--------------------------------------------------------------------------------------------------
...
#define STEP_CV_charge_current_limit               0
...
#define STEP_CV_step_abort_priority                1
#define STEP_CV_UnderTemperature_alarm             1
#define STEP_CV_timing_voltage_high                1
#define STEP_CV_timing_voltage_low                 1
#define STEP_CV_timing_voltage_change              1
#define STEP_CV_battery_short_voltage_high         1
#define STEP_CV_battery_short_voltage_low          1
//--------------------------------------------------------------------------------------------------
...
#define STEP_CC_to_CV_charge_current_limit               0
...
#define STEP_CC_to_CV_step_abort_priority                1
#define STEP_CC_to_CV_UnderTemperature_alarm             1
#define STEP_CC_to_CV_timing_voltage_high                1
#define STEP_CC_to_CV_timing_voltage_low                 1
#define STEP_CC_to_CV_timing_voltage_change              1
#define STEP_CC_to_CV_battery_short_voltage_high         1
#define STEP_CC_to_CV_battery_short_voltage_low          1
//--------------------------------------------------------------------------------------------------
...
#define STEP_CP_step_abort_priority                0
#define STEP_CP_UnderTemperature_alarm             0
#define STEP_CP_timing_voltage_high                0
#define STEP_CP_timing_voltage_low                 0
#define STEP_CP_timing_voltage_change              0
#define STEP_CP_battery_short_voltage_high         0
#define STEP_CP_battery_short_voltage_low          0
//--------------------------------------------------------------------------------------------------
...
#define STEP_DCC_discharge_current_limit            0
...
#define STEP_DCC_step_abort_priority                1
#define STEP_DCC_UnderTemperature_alarm             1
#define STEP_DCC_timing_voltage_high                1
#define STEP_DCC_timing_voltage_low                 1
#define STEP_DCC_timing_voltage_change              1
#define STEP_DCC_battery_short_voltage_high         1
#define STEP_DCC_battery_short_voltage_low          1
//--------------------------------------------------------------------------------------------------
...
#define STEP_DCV_discharge_current_limit            0
...
#define STEP_DCV_step_abort_priority                1
#define STEP_DCV_UnderTemperature_alarm             1
#define STEP_DCV_timing_voltage_high                1
#define STEP_DCV_timing_voltage_low                 1
#define STEP_DCV_timing_voltage_change              1
#define STEP_DCV_battery_short_voltage_high         1
#define STEP_DCV_battery_short_voltage_low          1
//--------------------------------------------------------------------------------------------------
...
#define STEP_DCC_to_DCV_discharge_current_limit            0
...
#define STEP_DCC_to_DCV_step_abort_priority                1
#define STEP_DCC_to_DCV_UnderTemperature_alarm             1
#define STEP_DCC_to_DCV_timing_voltage_high                1
#define STEP_DCC_to_DCV_timing_voltage_low                 1
#define STEP_DCC_to_DCV_timing_voltage_change              1
#define STEP_DCC_to_DCV_battery_short_voltage_high         1
#define STEP_DCC_to_DCV_battery_short_voltage_low          1
//--------------------------------------------------------------------------------------------------
...
#define STEP_DCP_step_abort_priority                0
#define STEP_DCP_UnderTemperature_alarm             0
#define STEP_DCP_timing_voltage_high                0
#define STEP_DCP_timing_voltage_low                 0
#define STEP_DCP_timing_voltage_change              0
#define STEP_DCP_battery_short_voltage_high         0
#define STEP_DCP_battery_short_voltage_low          0
//--------------------------------------------------------------------------------------------------
...
//     uint32_t step_OverTemperature_alarm:1;                  //电池温度上限保护
...
extern uint8_t jump_flag[CHANNELS][4];

extern uint8_t PG_count[CHANNELS];
#define PG_NUMBER 7

extern float contact_old_voltage[CHANNELS];
extern float contact_now_voltage[CHANNELS];

extern uint8_t timing_voltage_time_flag[CHANNELS];
extern uint8_t timing_voltage_change_time1_flag[CHANNELS];
extern uint8_t timing_voltage_change_time2_flag[CHANNELS];
extern float timing_voltage_change1[CHANNELS];
extern float timing_voltage_change2[CHANNELS];
extern float battery_short_time_flag[CHANNELS];
