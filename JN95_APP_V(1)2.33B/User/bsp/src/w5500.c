...
extern SPI_HandleTypeDef SPI1_Handler;         //SPI1句柄(用于W5500)
...
// uint16_t j = 0;
    ...
    HAL_SPI_TransmitReceive_DMA(&SPI1_Handler,spi_data,&spi_re,3);
    HAL_SPI_TransmitReceive_DMA(&SPI1_Handler,spi_data,&spi_re,len);
    bsp_DelayUS(len);                                 // 延时
#endif  
