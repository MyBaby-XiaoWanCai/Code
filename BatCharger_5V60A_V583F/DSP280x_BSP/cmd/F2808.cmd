...
PAGE 0:    /* Program Memory */
   ...
   FLASHDCB    : origin = 0x3E8000, length = 0x00BFF0     /* on-chip FLASH */
   //FLASHC      : origin = 0x3EC000, length = 0x004000     /* on-chip FLASH */
   //FLASHA      : origin = 0x3F4000, length = 0x003F80     /* on-chip FLASH */
   //CSM_RSVD    : origin = 0x3F7F80, length = 0x000076     /* Part of FLASHA.  Program with all 0x0000 when CSM is in use. */
   BEGIN       : origin = 0x3F3FF6, length = 0x000002     /* Part of FLASHA.  Used for "boot to Flash" bootloader mode. */
...
PAGE 1 :   /* Data Memory */
   ...
   RAMAPP      : origin = 0x00BFFF, length = 0x000001
}
...
SECTIONS
{
   ...
   .cinit              : > FLASHDCB      PAGE = 0
   .pinit              : > FLASHDCB,     PAGE = 0
   .text               : > FLASHDCB      PAGE = 0
   codestart           : > BEGIN       PAGE = 0
   ramfuncs            : LOAD = FLASHDCB,
                         RUN = RAML0, 
   ...
   .mySectorImage      : > RAML1       PAGE = 1
   /* Initalized sections go in Flash */
   /* For SDFlash to program these, they must be allocated to page 0 */
   .econst             : > FLASHDCB      PAGE = 0
   .switch             : > FLASHDCB      PAGE = 0

   /* Allocate IQ math areas: */
   IQmath              : > FLASHDCB      PAGE = 0                  /* Math Code */
