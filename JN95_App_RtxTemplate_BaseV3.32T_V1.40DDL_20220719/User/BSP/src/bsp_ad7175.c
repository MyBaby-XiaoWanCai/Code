...
** Author      : Huang Cheng
** Date        : 2021-08-23
** Description : ad7175 source file
**********************************************************************************************************/
...
uint32_t ad7175_value[16] = {0};          //AD7175数据缓冲区
...
uint32_t AD7175_WriteReg(uint8_t addr, uint32_t value, uint8_t size)
{
    ...
    uint8_t crc8     = 0;
    uint32_t ret = 0;
    uint8_t Txdata[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; //发送数据缓存
    uint8_t Rxdata[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; //接收数据缓存
