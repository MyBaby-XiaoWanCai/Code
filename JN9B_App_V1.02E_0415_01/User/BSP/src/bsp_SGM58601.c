...
void SGM58601_SpiInit(void)
{
    ...
    stcSpiInit.u32BaudRatePrescaler = SPI_BR_PCLK1_DIV16;      //波特率=PCLK1/16 =120M/16 =7.5M 
...
void SGM58601_EXTIX_Init(void)
{
    ...
    NVIC_SetPriority(SGM58601_IRQn, DDL_IRQ_PRIORITY_14); //设置优先级
...
uint32_t SGM58601_Read_Data(void)
{
    ...
    // bsp_DelayUS(7);                //等待10US ，50个时钟周期约等于6.7US
     SPI_TransmitReceive(SGM58601_SPI_UNIT,&txDate,&rxDate,3); 
