...
#define ETH_PHY_REF_CLK_50M  1        /* RMII Reference Clock (0:25MHz,1:50MHz) */
#endif
...
static int32_t PowerControl (ARM_POWER_STATE state) {
  uint16_t val;
  uint32_t tmout = PHY_TIMEOUT_COUNT;
