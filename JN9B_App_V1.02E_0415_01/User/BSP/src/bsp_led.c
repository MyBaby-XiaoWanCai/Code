...
uint8_t LampPlate_OldOn[18] = {0x7F,0xBF,0x01,0x01,0x02,0x04,0x04,0x08,0x08,
											0x10,0x10,0x20,0x20,0x40,0x40,0x80,0x80};	//偶数位-绿灯置低; 基数位-红灯置低,其他位保持不变
//置高位
uint8_t LampPlate_NewOn[18] = {0x80,0x40,0xFE,0xFE,0xFD,0xFD,0xFB,0xFB,0xF7,0xF7,
											0xEF,0xEF,0xDF,0xDF,0xBF,0xBF,0x7F,0x7F};//偶数位-红灯置高; 基数位-绿灯置高,其他位保持不变						
...
void bsp_LedOn(uint8_t _no)
{
	...
	if(_no == LED_82_NO || _no == LED_83_NO)
	{
