...
void InitEPwm9Gpio(void)
{
    ...
    // Comment out other unwanted lines.
    //
    GpioCtrlRegs.GPAGMUX2.bit.GPIO16 = 1; // Configure GPIO16 as SPISIMOA
    GpioCtrlRegs.GPAMUX2.bit.GPIO16 = 1;

    GpioCtrlRegs.GPAGMUX2.bit.GPIO17 = 1; // Configure GPIO16 as SPISIMOA
...
void InitEPwm10Gpio(void)
{
    ...
    // Comment out other unwanted lines.
    //
    GpioCtrlRegs.GPAPUD.bit.GPIO18 = 1;    // Disable pull-up on GPIO14 (EPWM8A)
    GpioCtrlRegs.GPAPUD.bit.GPIO19 = 1;    // Disable pull-up on GPIO15 (EPWM8B)
...
void InitEPwm11Gpio(void)
{
    ...
    // Comment out other unwanted lines.
    //
    GpioCtrlRegs.GPAPUD.bit.GPIO20 = 1;    // Disable pull-up on GPIO165 (EPWM11A)
    ...
    // Comment out other unwanted lines.
    //
    GpioCtrlRegs.GPAGMUX2.bit.GPIO20 = 1; // Configure GPIO16 as SPISIMOA
    GpioCtrlRegs.GPAMUX2.bit.GPIO20 = 1;

    GpioCtrlRegs.GPAGMUX2.bit.GPIO21 = 1; // Configure GPIO16 as SPISIMOA
...
void InitEPwm12Gpio(void)
{
    ...
    // Comment out other unwanted lines.
    //
      GpioCtrlRegs.GPAPUD.bit.GPIO22 = 1;    // Disable pull-up on GPIO165 (EPWM11A)
      GpioCtrlRegs.GPAPUD.bit.GPIO23 = 1;    // Disable pull-up on GPIO166 (EPWM11B)
      ...
      // Comment out other unwanted lines.
      //
      GpioCtrlRegs.GPAGMUX2.bit.GPIO22 = 1; // Configure GPIO16 as SPISIMOA
      GpioCtrlRegs.GPAMUX2.bit.GPIO22 = 1;

      GpioCtrlRegs.GPAGMUX2.bit.GPIO23 = 1; // Configure GPIO16 as SPISIMOA
