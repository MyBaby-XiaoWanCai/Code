...
{
    EALLOW;
    InputXbarRegs.INPUT1SELECT = pin;       //Set XINT1 source to GPIO-pin
    EDIS;
}
...
{
    EALLOW;
    InputXbarRegs.INPUT2SELECT = pin;       //Set XINT2 source to GPIO-pin
    EDIS;
}
...
{
    EALLOW;
    InputXbarRegs.INPUT3SELECT = pin;       //Set XINT3 source to GPIO-pin
    EDIS;
}
...
{
    EALLOW;
    InputXbarRegs.INPUT6SELECT = pin;     //Set XINT4 source to GPIO-pin
    EDIS;
}
