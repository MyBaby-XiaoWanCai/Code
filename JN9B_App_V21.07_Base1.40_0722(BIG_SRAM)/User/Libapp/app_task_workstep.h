...
#ifdef YCJ
#define CHANNEL_CFG		Weaver_Config	//通道并联配置 8-120A机型 4-240A机型 1-600A机型
...
#define WORK_VOL_MAX				4.5f
#define WORK_VOL_MIN				2.5f
#ifdef YCJ
#define WORK_CUR_MAX				(120.0f*(CHANNEL_MAX / CHANNEL_CFG))
#else
...
void Debug_Weaver_2(uint8_t CHx,uint8_t State);	//并机模式Debug函数
#ifdef __cplusplus
}
#endif	
