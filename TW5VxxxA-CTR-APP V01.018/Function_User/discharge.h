...
#define Fan_I_Max   250.0

// #define Iport_MAX 50
// #define I_MAX Iport_MAX*CHANNELS
// #define Ich_MAX I_MAX

extern float fan_I;
extern float fan[6];

extern uint8_t ageing_flag;
// extern uint8_t  selt_flag;
// extern uint8_t  self_ch;
// #define SELF_NUMBER 10
...
#define PORT1_EN {HAL_GPIO_WritePin(GPIOH, GPIO_PIN_9, GPIO_PIN_SET);}
#define PORT2_EN {HAL_GPIO_WritePin(GPIOH, GPIO_PIN_10, GPIO_PIN_SET);}
#define PORT3_EN {HAL_GPIO_WritePin(GPIOH, GPIO_PIN_11, GPIO_PIN_SET);}
#define PORT4_EN {HAL_GPIO_WritePin(GPIOH, GPIO_PIN_12, GPIO_PIN_SET);}
#define PORT5_EN {HAL_GPIO_WritePin(GPIOB, GPIO_PIN_14, GPIO_PIN_SET);}
#define PORT6_EN {HAL_GPIO_WritePin(GPIOD, GPIO_PIN_10, GPIO_PIN_SET);}
#define PORT7_EN {HAL_GPIO_WritePin(GPIOD, GPIO_PIN_11, GPIO_PIN_SET);}
#define PORT8_EN {HAL_GPIO_WritePin(GPIOD, GPIO_PIN_12, GPIO_PIN_SET);}
...
#define PORT1_DIS {HAL_GPIO_WritePin(GPIOH, GPIO_PIN_9, GPIO_PIN_RESET);}
#define PORT2_DIS {HAL_GPIO_WritePin(GPIOH, GPIO_PIN_10, GPIO_PIN_RESET);}
#define PORT3_DIS {HAL_GPIO_WritePin(GPIOH, GPIO_PIN_11, GPIO_PIN_RESET);}
#define PORT4_DIS {HAL_GPIO_WritePin(GPIOH, GPIO_PIN_12, GPIO_PIN_RESET);}
#define PORT5_DIS {HAL_GPIO_WritePin(GPIOB, GPIO_PIN_14, GPIO_PIN_RESET);}
#define PORT6_DIS {HAL_GPIO_WritePin(GPIOD, GPIO_PIN_10, GPIO_PIN_RESET);}
#define PORT7_DIS {HAL_GPIO_WritePin(GPIOD, GPIO_PIN_11, GPIO_PIN_RESET);}
#define PORT8_DIS {HAL_GPIO_WritePin(GPIOD, GPIO_PIN_12, GPIO_PIN_RESET);}
...
#define PORT_DIR_BUCK(n) {switch(n+1) { \
                        case 1: PORT1_BUCK;break; \
                        case 2: PORT2_BUCK;break; \
                        case 3: PORT3_BUCK;break; \
                        case 4: PORT4_BUCK;break; \
                        case 5: PORT5_BUCK;break; \
                        case 6: PORT6_BUCK;break; \
                        case 7: PORT7_BUCK;break; \
                        case 8: PORT8_BUCK;break; \
                        default: break; }}
...
#define PORT_DIR_BOOST(n) {switch(n+1) { \
                        case 1: PORT1_BOOST;break; \
                        case 2: PORT2_BOOST;break; \
                        case 3: PORT3_BOOST;break; \
                        case 4: PORT4_BOOST;break; \
                        case 5: PORT5_BOOST;break; \
                        case 6: PORT6_BOOST;break; \
                        case 7: PORT7_BOOST;break; \
                        case 8: PORT8_BOOST;break; \
                        default: break; }}
...
#define V3_OUT  PHout(15)
#define V4_OUT  PGout(15)
...
#define MODE_PORT1   PDout(13)
#define MODE_PORT2   PDout(14)
#define MODE_PORT3   PDout(15)
#define MODE_PORT4   PGout(2)
#define MODE_PORT5   PGout(3)
#define MODE_PORT6   PGout(4)
#define MODE_PORT7   PGout(5)
#define MODE_PORT8   PGout(6)

#define MODE_PORT1_MASTER   {HAL_GPIO_WritePin(GPIOD, GPIO_PIN_13, GPIO_PIN_RESET);}
#define MODE_PORT2_MASTER   {HAL_GPIO_WritePin(GPIOD, GPIO_PIN_14, GPIO_PIN_RESET);}
#define MODE_PORT3_MASTER   {HAL_GPIO_WritePin(GPIOD, GPIO_PIN_15, GPIO_PIN_RESET);}
#define MODE_PORT4_MASTER   {HAL_GPIO_WritePin(GPIOG, GPIO_PIN_2, GPIO_PIN_RESET);}
#define MODE_PORT5_MASTER   {HAL_GPIO_WritePin(GPIOG, GPIO_PIN_3, GPIO_PIN_RESET);}
#define MODE_PORT6_MASTER   {HAL_GPIO_WritePin(GPIOG, GPIO_PIN_4, GPIO_PIN_RESET);}
#define MODE_PORT7_MASTER   {HAL_GPIO_WritePin(GPIOG, GPIO_PIN_5, GPIO_PIN_RESET);}
#define MODE_PORT8_MASTER   {HAL_GPIO_WritePin(GPIOG, GPIO_PIN_6, GPIO_PIN_RESET);}

#define MODE_PORT_MASTER(n) {switch(n+1) { \
                                case 1: MODE_PORT1_MASTER;break; \
                                case 2: MODE_PORT2_MASTER;break; \
                                case 3: MODE_PORT3_MASTER;break; \
                                case 4: MODE_PORT4_MASTER;break; \
                                case 5: MODE_PORT5_MASTER;break; \
                                case 6: MODE_PORT6_MASTER;break; \
                                case 7: MODE_PORT7_MASTER;break; \
                                case 8: MODE_PORT8_MASTER;break; \
                                default: break; }}

#define MODE_PORT1_SLAVE    {HAL_GPIO_WritePin(GPIOD, GPIO_PIN_13, GPIO_PIN_SET);}
#define MODE_PORT2_SLAVE    {HAL_GPIO_WritePin(GPIOD, GPIO_PIN_14, GPIO_PIN_SET);}
#define MODE_PORT3_SLAVE    {HAL_GPIO_WritePin(GPIOD, GPIO_PIN_15, GPIO_PIN_SET);}
#define MODE_PORT4_SLAVE    {HAL_GPIO_WritePin(GPIOG, GPIO_PIN_2, GPIO_PIN_SET);}
#define MODE_PORT5_SLAVE    {HAL_GPIO_WritePin(GPIOG, GPIO_PIN_3, GPIO_PIN_SET);}
#define MODE_PORT6_SLAVE    {HAL_GPIO_WritePin(GPIOG, GPIO_PIN_4, GPIO_PIN_SET);}
#define MODE_PORT7_SLAVE    {HAL_GPIO_WritePin(GPIOG, GPIO_PIN_5, GPIO_PIN_SET);}
#define MODE_PORT8_SLAVE    {HAL_GPIO_WritePin(GPIOG, GPIO_PIN_6, GPIO_PIN_SET);}

#define MODE_PORT_SLAVE(n)  {switch(n+1) { \
                                case 1: MODE_PORT1_SLAVE;break; \
                                case 2: MODE_PORT2_SLAVE;break; \
                                case 3: MODE_PORT3_SLAVE;break; \
                                case 4: MODE_PORT4_SLAVE;break; \
                                case 5: MODE_PORT5_SLAVE;break; \
                                case 6: MODE_PORT6_SLAVE;break; \
                                case 7: MODE_PORT7_SLAVE;break; \
                                case 8: MODE_PORT8_SLAVE;break; \
                                default: break; }}
