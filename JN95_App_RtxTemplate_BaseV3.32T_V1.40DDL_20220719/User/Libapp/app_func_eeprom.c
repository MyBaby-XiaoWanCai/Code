...
#ifdef	YCJ	
	Tier2.iProt[j].IoutThr.value   = 35;
#else    
...
void CalibrateDatInit(uint8_t chx)
{
	uint8_t j = chx;
#ifdef	YCJ
    Tier2.calibrate[j].VsenseSetK_C = 9849.36328;
	Tier2.calibrate[j].VsenseSetB_C = 0;
	Tier2.calibrate[j].VmodSetK_C   = 8931.53027;
	Tier2.calibrate[j].VmodSetB_C   = 0;
	Tier2.calibrate[j].IhSetK_C     = 1446;        //修改1
	Tier2.calibrate[j].IhSetB_C     = 0;           //修改1
	Tier2.calibrate[j].IlSetK_C     = 1835.53503;
	Tier2.calibrate[j].IlSetB_C     = 0;
	Tier2.calibrate[j].VsenseK_C    = 5.50281;
	Tier2.calibrate[j].VsenseB_C    = -0.329;
	Tier2.calibrate[j].VmodK_C      = 9.09;
	Tier2.calibrate[j].VmodB_C      = -0.25;
	Tier2.calibrate[j].IhK_C        = 50;          //修改1
	Tier2.calibrate[j].IhB_C        = 0;           //修改1
	Tier2.calibrate[j].IlK_C        = 39.285141;
	Tier2.calibrate[j].IlB_C        = 0;
	Tier2.calibrate[j].VtzK_C       = 5.00094;
	Tier2.calibrate[j].VtzB_C       = 0;

	Tier2.calibrate[j].VsenseSetK_D = 9849.36328;
	Tier2.calibrate[j].VsenseSetB_D = 0;
	Tier2.calibrate[j].VmodSetK_D   = 8931.53027;
	Tier2.calibrate[j].VmodSetB_D   = 0;
	Tier2.calibrate[j].IhSetK_D     = 1446;        //修改1
	Tier2.calibrate[j].IhSetB_D     = 0;           //修改1
	Tier2.calibrate[j].IlSetK_D     = 1835.53503;
	Tier2.calibrate[j].IlSetB_D     = 0;
	Tier2.calibrate[j].VsenseK_D    =  5.50281;
	Tier2.calibrate[j].VsenseB_D    = -0.329;
	Tier2.calibrate[j].VmodK_D      = 9.09;
	Tier2.calibrate[j].VmodB_D      = -0.25;
	Tier2.calibrate[j].IhK_D        = 50;    //修改1
	Tier2.calibrate[j].IhB_D        = 0;     //修改1
	Tier2.calibrate[j].IlK_D        = 39.285141;
	Tier2.calibrate[j].IlB_D        = 0;
	Tier2.calibrate[j].VtzK_D       = 5.00094;
	Tier2.calibrate[j].VtzB_D       = 0; 
    
//	Tier2.calibrate[j].VsenseSetK_C = 9838.254883;
//	Tier2.calibrate[j].VsenseSetB_C = -5.830758;
//	Tier2.calibrate[j].VmodSetK_C   = 8930.311523;
//	Tier2.calibrate[j].VmodSetB_C   = 5.915592;
//	Tier2.calibrate[j].IhSetK_C     = 1446;        //修改1
//	Tier2.calibrate[j].IhSetB_C     = 0;   //修改1
//	Tier2.calibrate[j].IlSetK_C     = 1835.535034;
//	Tier2.calibrate[j].IlSetB_C     = 0;
//	Tier2.calibrate[j].VsenseK_C    = 5.499214;
//	Tier2.calibrate[j].VsenseB_C    = -0.329117;
//	Tier2.calibrate[j].VmodK_C      = 8.942759;
//	Tier2.calibrate[j].VmodB_C      = -0.272346;
//	Tier2.calibrate[j].IhK_C        = 50;          //修改1
//	Tier2.calibrate[j].IhB_C        = 0;   //修改1
//	Tier2.calibrate[j].IlK_C        = 39.285141;
//	Tier2.calibrate[j].IlB_C        = 0;
//	Tier2.calibrate[j].VtzK_C       = 4.998415;
//	Tier2.calibrate[j].VtzB_C       = 0.002736;

//	Tier2.calibrate[j].VsenseSetK_D = 9838.254883;
//	Tier2.calibrate[j].VsenseSetB_D = -5.830758;
//	Tier2.calibrate[j].VmodSetK_D   = 8930.311523;
//	Tier2.calibrate[j].VmodSetB_D   = 5.915592;
//	Tier2.calibrate[j].IhSetK_D     = 1446;  //修改1
//	Tier2.calibrate[j].IhSetB_D     = 0;    //修改1
//	Tier2.calibrate[j].IlSetK_D     = 1835.535034;
//	Tier2.calibrate[j].IlSetB_D     = 0;
//	Tier2.calibrate[j].VsenseK_D    = 5.499214;
//	Tier2.calibrate[j].VsenseB_D    = -0.329117;
//	Tier2.calibrate[j].VmodK_D      = 8.942759;
//	Tier2.calibrate[j].VmodB_D      = -0.272346;
//	Tier2.calibrate[j].IhK_D        = 50;    //修改1
//	Tier2.calibrate[j].IhB_D        = 0;    //修改1
//	Tier2.calibrate[j].IlK_D        = 39.285141;
//	Tier2.calibrate[j].IlB_D        = 0;
//	Tier2.calibrate[j].VtzK_D       = 4.998415;
//	Tier2.calibrate[j].VtzB_D       = 0.002736;    
#else     //适用H版
        ...
        Tier2.calibrate[j].VmodSetK_C   = 8930.311523;
        Tier2.calibrate[j].VmodSetB_C   = 5.915592;
        Tier2.calibrate[j].IhSetK_C     = 734.005493;
        Tier2.calibrate[j].IhSetB_C     = 0;
        Tier2.calibrate[j].IlSetK_C     = 1835.535034;
        Tier2.calibrate[j].IlSetB_C     = 0;
        Tier2.calibrate[j].VsenseK_C    = 5.499214;
        Tier2.calibrate[j].VsenseB_C    = -0.329117;
        Tier2.calibrate[j].VmodK_C      = 8.942759;
        Tier2.calibrate[j].VmodB_C      = -0.272346;
        Tier2.calibrate[j].IhK_C        = 98.235359;
        Tier2.calibrate[j].IhB_C        = 0;
        Tier2.calibrate[j].IlK_C        = 39.285141;
        Tier2.calibrate[j].IlB_C        = 0;
        Tier2.calibrate[j].VtzK_C       = 4.998415;
        Tier2.calibrate[j].VtzB_C       = 0.002736;
        ...
        Tier2.calibrate[j].VmodSetK_D   = 8930.311523;
        Tier2.calibrate[j].VmodSetB_D   = 5.915592;
        Tier2.calibrate[j].IhSetK_D     = 734.005493;
        Tier2.calibrate[j].IhSetB_D     = 0;
        Tier2.calibrate[j].IlSetK_D     = 1835.535034;
        Tier2.calibrate[j].IlSetB_D     = 0;
        Tier2.calibrate[j].VsenseK_D    = 5.499214;
        Tier2.calibrate[j].VsenseB_D    = -0.329117;
        Tier2.calibrate[j].VmodK_D      = 8.942759;
        Tier2.calibrate[j].VmodB_D      = -0.272346;
        Tier2.calibrate[j].IhK_D        = 98.235359;
        Tier2.calibrate[j].IhB_D        = 0;
        Tier2.calibrate[j].IlK_D        = 39.285141;
        Tier2.calibrate[j].IlB_D        = 0;
        Tier2.calibrate[j].VtzK_D       = 4.998415;
        Tier2.calibrate[j].VtzB_D       = 0.002736;
  ...
  /*YCJ并机测试*/
	...
	Tier2.calibrate[j].VtzB_D       = 0;  
...
#if 1      //适用J版
        Tier2.calibrate[j].VsenseSetK_C = 9849.36328;                // 9838.254883;
        ...
        Tier2.calibrate[j].IhSetK_C     = 680;                                // 734.005493;
...
{
	uint8_t  eeprom_init_flg = 0;
	uint8_t  eeprom_init_cnt = 0;
	uint8_t  ucBuf[2];
	...
	/* 校准参数 */
	while((eeprom_init_flg == 0) && (eeprom_init_cnt < 5))
	{
		...
		else /* if(usage_flag == CALIBRATE_UNUSED) */
		{
			...
			if(eeprom_init_cnt >= 5)
			{
				usage_flag = CALIBRATE_USED;
				memcpy(ucBuf, &usage_flag, 2);
				ee_WriteBytesWithCheck(ucBuf, CALIBRATE_USAGE_FLAG_ADDR, 2);		
				for(int j = 0; j < CHANNEL_MAX; j++)
				{
					CalibrateDatInit(j);
...
//				memcpy(ucBuf, &usage_flag, 2);
//				ee_WriteBytesWithCheck(ucBuf, PROTECT_GLOBAL_USAGE_FLAG_ADDR, 2);		
//				for(int j = 0; j < CHANNEL_MAX; j++)
//				{
	...
	{		
		...
		{	
			...
			if(eeprom_init_cnt >= 5)
			{
				...
				memcpy(ucBuf, &usage_flag, 2);
				ee_WriteBytesWithCheck(ucBuf, PROTECT_INTERNAL_USAGE_FLAG_ADDR, 2);			
				for(int j = 0; j < CHANNEL_MAX; j++)
				{
