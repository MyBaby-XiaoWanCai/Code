...
static void ADC_Switch_Channel(uint8_t SW)
{
    uint8_t i;
    uint8_t j;
    uint16_t ADCxCHxValue_temp[8]= {0};
    ...
    switch(SW)
    {
		...
		{		
			...
			ADCx_Vmod[0] = (float)ADCxCHxValue_temp[4] / DMA_CH_samp;
			ADCx_Vmod[1] = (float)ADCxCHxValue_temp[5] / DMA_CH_samp;
			ADCx_Temp[0] = (float)ADCxCHxValue_temp[6] / DMA_CH_samp;
			ADCx_Temp[1] = (float)ADCxCHxValue_temp[7] / DMA_CH_samp;
		...
		case 1:
		{
			...
			ADCx_Vmod[2] = (float)ADCxCHxValue_temp[4] / DMA_CH_samp;
			ADCx_Vmod[3] = (float)ADCxCHxValue_temp[5] / DMA_CH_samp;
			ADCx_Temp[2] = (float)ADCxCHxValue_temp[6] / DMA_CH_samp;
			ADCx_Temp[3] = (float)ADCxCHxValue_temp[7] / DMA_CH_samp;
		...
		case 2:
		{
			...
			ADCx_Vmod[4] = (float)ADCxCHxValue_temp[4] / DMA_CH_samp;
			ADCx_Vmod[5] = (float)ADCxCHxValue_temp[5] / DMA_CH_samp;
			ADCx_Temp[4] = (float)ADCxCHxValue_temp[6] / DMA_CH_samp;
			ADCx_Temp[5] = (float)ADCxCHxValue_temp[7] / DMA_CH_samp;
		...
		case 3:
		{
			...
			ADCx_Vmod[6] = (float)ADCxCHxValue_temp[4] / DMA_CH_samp;
			ADCx_Vmod[7] = (float)ADCxCHxValue_temp[5] / DMA_CH_samp;
			ADCx_Temp[6] = (float)ADCxCHxValue_temp[6] / DMA_CH_samp;
			ADCx_Temp[7] = (float)ADCxCHxValue_temp[7] / DMA_CH_samp;
