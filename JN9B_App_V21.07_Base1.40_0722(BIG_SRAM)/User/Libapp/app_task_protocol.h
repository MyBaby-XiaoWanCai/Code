...
**                                            宏定义区
**********************************************************************************************************/
#define ITEMP_MAX_SELECT

#ifdef ITEMP_MAX_SELECT
	#define ITEMP_MAX						(130)	//130
#else
	#define ITEMP_MAX						(95)
#endif
...
#define SCMD_SYSTEM_SET_END						0x15
...
#ifdef YCJ
/* 版本号 */
#define SOFTWARE_PRIVERSION					21.07f	/* 主版本号 */
#define SOFTWARE_SUBVERSION					'G'	/* 子版本号 */
#else
/* 版本号(V3.32) */
#define SOFTWARE_PRIVERSION					2.02f	/* 主版本号 */
#define SOFTWARE_SUBVERSION					'E'	/* 子版本号 */
#endif
