...
/**
 * @brief  W5500 SPI unit configurate for master
 * @param  [in]  None
 * @retval None.
 */
...
/**
 * @brief  AD7124 SPI unit configurate for master
 * @param  [in]  None
 * @retval None.
 */
...
/**
 * @brief  AD7175 SPI unit configurate for master
 * @param  [in]  None
 * @retval None.
 */
...
/**
 * @brief  DA80508_1 SPI unit configurate for master
 * @param  [in]  None
 * @retval None.
 */
...
/**
 * @brief  DA80508_2 SPI unit configurate for master
 * @param  [in]  None
 * @retval None.
 */
...
/**
 * @brief  W25Q16JVSSIQ and MB85RS2MTA SPI unit configurate for master
 * @param  [in]  None
 * @retval None.
 */
void W25Q_MB85R_SpiInit(void)
{
    ...
    stcGpioCfg.u16PinDrv = PIN_DRV_HIGH;
    stcGpioCfg.u16PinState = PIN_STATE_SET;
    (void)GPIO_Init(W25Q_NSS_PORT,  W25Q_NSS_PIN, &stcGpioCfg);
