...
/******************************************************************************/
extern uint8_t AD7124_Start_Read;
extern uint32_t ad7124_value[16];
extern uint8_t ad7124_compute_crc8(uint8_t * p_buf, uint8_t buf_size);
extern int32_t AD7124_WriteReg(uint8_t addr,int32_t Value,uint8_t size);
...
extern int32_t AD7124_WaitFor_Conv_Ready(uint8_t* ch,uint32_t timeout);
extern int32_t AD7124_ReadData(uint8_t* pData);
