...
#define MB85R_NSS_1()           HAL_GPIO_WritePin(SPI3_NSS_FRAM_GPIO_Port, SPI3_NSS_FRAM_Pin, GPIO_PIN_SET)		//MB85R片选信号		
#define MB85R_NSS_0()           HAL_GPIO_WritePin(SPI3_NSS_FRAM_GPIO_Port, SPI3_NSS_FRAM_Pin, GPIO_PIN_RESET)
