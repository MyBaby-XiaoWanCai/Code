...
#define PB_CH1_ADDR		(0x40)
#define PB_CH2_ADDR		(0x42)
#define PB_CH3_ADDR		(0x44)
#define PB_CH4_ADDR		(0x46)
#define PB_CH5_ADDR		(0x48)
#define PB_CH6_ADDR		(0x4A)
#define PB_CH7_ADDR		(0x4C)
#define PB_CH8_ADDR		(0x4E)

extern uint8_t PB_Addr_Arr[8];
