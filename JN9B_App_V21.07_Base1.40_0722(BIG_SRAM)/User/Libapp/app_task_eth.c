...
//			if((ACDC_UpdateFlg==0)&&(Net_Mod_State.NetMod_cnt > 60*1000) && (client_conFlg == 0) && (g_ucSysMode == SYS_NORMAL_MODE)) //服务器60秒内无连接则切换到客户端模式
			if((Net_Mod_State.NetMod_cnt > 60*1000) && (client_conFlg == 0) && (g_ucSysMode == SYS_NORMAL_MODE)) //服务器60秒内无连接则切换到客户端模式
			{
